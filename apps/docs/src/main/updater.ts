...
/**
 * Optional full-package auto-update for the standalone Open GenOffice Docs app.
 *
 ...
 * latest-mac.yml on macOS) next to the installers. Standalone docs builds
 * currently ship without a publish config, so packaged runs simply log the
 * missing-feed error.
 *
