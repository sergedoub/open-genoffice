...
const api: SlidesApi = {
  ...
  getAiPublicSettings: () => ipcRenderer.invoke('ai:settings:get-public'),
  listAiModels: (args?: ListAiModelsArgs) => ipcRenderer.invoke('ai:models:list', args),
  getAiConversationRoute: (identity: AiConversationIdentity) =>
    ipcRenderer.invoke('ai:conversation:get-route', identity),
  setAiConversationRoute: (identity: AiConversationIdentity, route: AiRoute) =>
    ipcRenderer.invoke('ai:conversation:set-route', identity, route),
