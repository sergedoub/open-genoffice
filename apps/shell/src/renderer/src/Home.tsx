...
import { resolveAiSettingsApi } from './settings/ai-settings-api'
    ...
    <div className="home">
      <aside className="sidebar">
        <div className="sidebar-logo">
          <img className="logo-lockup-icon" src={appIcon} alt="" aria-hidden="true" />
          <span className="logo-lockup-text">Open GenOffice</span>
        </div>
      ...
      {settingsOpen && (
        <AiSettingsModal api={resolveAiSettingsApi()} onClose={() => setSettingsOpen(false)} />
      )}
    </div>
  )
}
