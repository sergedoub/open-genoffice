...
export type SecureAiStreamRequest = import('../../../docs/src/shared/ipc').AiStreamRequest
...
export interface DesktopApi {
  ...
  /** Compatibility view with blank apiKey fields; secrets never cross IPC. */
  ...
  aiStream(request: SecureAiStreamRequest): Promise<void>
