...
const desktopApi: DesktopApi = {
  ...
  getAiPublicSettings: () => ipcRenderer.invoke(IPC_CHANNELS.aiGetPublicSettings),
  setAiGlobalDefault: (route) => ipcRenderer.invoke(IPC_CHANNELS.aiSetGlobalDefault, route),
  verifyAndSaveAiProvider: (args) => ipcRenderer.invoke(IPC_CHANNELS.aiVerifyAndSaveProvider, args),
  removeAiProviderKey: (providerId) =>
    ipcRenderer.invoke(IPC_CHANNELS.aiRemoveProviderKey, providerId),
  listAiModels: (args) => ipcRenderer.invoke(IPC_CHANNELS.aiListModels, args),
  refreshAiModels: (args) => ipcRenderer.invoke(IPC_CHANNELS.aiRefreshModels, args),
  getAiConversationRoute: (identity) =>
    ipcRenderer.invoke(IPC_CHANNELS.aiGetConversationRoute, identity),
  setAiConversationRoute: (identity, route) =>
    ipcRenderer.invoke(IPC_CHANNELS.aiSetConversationRoute, identity, route),
  async aiChat(request) {
    const result: unknown = await ipcRenderer.invoke(IPC_CHANNELS.aiChat, {
  ...
  async aiStream(request) {
    await ipcRenderer.invoke(IPC_CHANNELS.aiStream, {
